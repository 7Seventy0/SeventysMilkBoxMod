...
namespace SeventysMilkBoxMod
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        void Start()
        {
            ConfigFile config = new ConfigFile(Path.Combine(Paths.ConfigPath, "SeventysMilkBox.cfg"), true);
        ...
        void OnGameInitialized(object sender, EventArgs e)
        {
            ...
            {
                Stream str = Assembly.GetExecutingAssembly().GetManifestResourceStream("SeventysMilkBoxMod.Assets.gorillamilkbundle");
                ...
                var milk = bundle.LoadAsset<GameObject>("gorillaMilk");
